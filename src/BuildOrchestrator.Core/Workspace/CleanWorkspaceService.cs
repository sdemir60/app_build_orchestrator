...
/// <c>bin</c> ve <c>obj</c>'idir: <c>packages\</c> ve ortak OutDir DOKUNULMADAN kalır. Worktree havuzu zaten
/// YOK — bkz. <c>LegacyWorktreePool</c> (kalan eski klasörü Clean değil, App'in ilk motor-hazır ipucu anar).</para>
///
