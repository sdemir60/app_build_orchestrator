...
/// <summary>
/// [tray indicator/T3] Tepside koşan derlemeyi gösteren animasyonlu marka işareti. Çizimi ve zaman çizelgesi
/// <c>TrayBuildIndicator.xaml</c>'dedir (kaynak sanat, verbatim); burada yalnız döngünün SÜRÜŞÜ vardır.
///
