...
/// bir bağımlılık uyarısı taşıyor" sorusunu yanıtlar.
/// </summary>
                                          ...
                                          int Failed, int Skipped, int DepAffected)
{
    ...
    {
        int total = 0, building = 0, queued = 0, succeeded = 0, failed = 0, skipped = 0, dep = 0;
        ...
        return new RunCounters(total, building, queued, succeeded, failed, skipped, dep);
    }
}
