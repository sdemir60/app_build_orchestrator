...
public static class ReleaseNotes
{
    ...
    [
        ...
        [
            ...
            new(NoteKind.Added, "A layer heading in the project list is a shortcut too: hover lifts it, and clicking scrolls that group's first row up to sit just under the stacked headings above it. It only moves the scroll position — selection, the filter and the console are untouched."),
