...
public static class ReleaseNotes
{
    ...
    [
        ...
        [
            ...
            new(NoteKind.Added, "Drop to the tray while a build is running and the product mark animates in the bottom-right corner of the screen with the ribbon's built/to-build counter — click it to bring the window back. When the run ends, Windows shows a notification with the result; a run that ends with the window open shows none."),
