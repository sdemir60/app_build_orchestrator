...
> **Paket sürümü: v1.12.1** · tarih: 2026-09-08 — değişenler için → [Sürüm geçmişi](#sürüm-geçmişi)
>
...
- **Sol şerit (v1.11.0, v1.12.0):** her satırda görünür — **başlangıç modunda soluk düz gri (opaklık 0.5)**, işlem başlayınca tam gri, işaretlenince amber, bitişte sonuç rengi. Sync şeridi soluk hâle döndürür (plan göstermez). Şerit 2px (seçilide 3px) ve **1px dikey iç boşluklu** — boşluk satır ayracı kadar: bitişik satırlarda tek kesintisiz çizgiye kaynamaz, ama araları da açılmaz.
...
| başlangıç modu (`fresh`) | soluk düz şerit (0.5) + 4 yaylı nokta + kesikli daire glyph (DS, değişmedi) / kesikli node border (değişmedi) | `--status-skipped-border` | tooltip yok — Sync sonrası ve açılışta herkes bu moddadır (v1.12.0) |
