          ...
          return (
            <div key={p.name} data-n={p.name}
              ...
              <div style={{
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke={tone.core} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round"
