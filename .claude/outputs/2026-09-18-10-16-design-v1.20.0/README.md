...
> **Paket sürümü: v1.20.0** · tarih: 2026-09-18 — değişenler için → [Sürüm geçmişi](#sürüm-geçmişi)
>
...
> davranışları temsil eder. Bu sürümde yalnız metin değişti: renk artık son işlemin hikâyesini değil,
> çıktının kümülatif durumunu anlatır (§2.3, §2.4, §2.7, §3.1, §5, §8, §9).
...
> - **Nötr kontrol** (Sync · bakım ikonları · sayaç/filtre çipleri · `N behind` · branch/worktree/perf): zemin `neutral-700` (#2a2a30), border `neutral-500` (#54545c), **metin VE ikon** `text-primary` — üç kanal birlikte değişir, kontrol türüne göre fark yok. Statü glyph'i (✓ ✗ —) kendi statü rengini korur (renk statü taşır).
