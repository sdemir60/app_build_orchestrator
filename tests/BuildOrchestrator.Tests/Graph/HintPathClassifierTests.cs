...
public class HintPathClassifierTests
{
    ...
    [Fact]
    public void classifies_edge_thirdparty_platformbin_and_unclassified()
    {
        var a = P("C:\\r\\A.csproj", "OSYS.A",
            ...
            "C:\\OSYS\\Server\\Bin\\OSYS.Kernel.dll",            // ExternalPlatformBin (\Bin\, producer yok)
        ...
        Assert.Equal(1, r.PlatformBinCount);
